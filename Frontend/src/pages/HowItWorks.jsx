...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description:
        "After winning an item, the highest bidder will receive an email with the Auctioneer's payment method information, including bank transfer, Google Pay, and PayPal.",
    },
    {
      icon: <FaDollarSign />,
