    ...
    for (const auction of endedAuctions) {
      try {
        ...
        if (highestBidder) {
          ...
          const message = `Dear ${bidder.userName}, \n\nCongratulations! You have won the auction for ${auction.title}. \n\nBefore proceeding for payment contact your auctioneer via your 
